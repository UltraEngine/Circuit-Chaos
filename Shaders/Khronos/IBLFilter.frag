...
layout(location = 1) uniform float lodBias = 0.0f;
layout(location = 2) uniform uint sampleCount = 32;
layout(location = 3) uniform uint currentMipLevel = 0;
layout(location = 4) uniform uint width = 256;
layout(location = 5) uniform uint distribution = 0;
layout(location = 6) uniform float roughness = 0.0f;
layout(location = 7) uniform ivec4 DrawViewport;
